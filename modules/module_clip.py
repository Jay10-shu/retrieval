...
class CLIP(nn.Module):
    ...
    def get_config(pretrained_clip_name="ViT-B/32"):
        ...
        # print('-------------xxxxxxxxxxxxxxxxxxxxxxxx-model_path',model_path)
        try:
            # loading JIT archive
        ...
        #     # Optionally print the first few layers of the state_dict
        #     print("State_dict keys (first 5):", list(state_dict.keys())[:5])
        # else:
    ...
    def encode_text(self, text, return_hidden=False):
        ...
        # take features from the eot embedding (eot_token is the highest number in each sequence)   全局特征/序列特征
