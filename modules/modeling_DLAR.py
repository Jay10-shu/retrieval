...
from modules.until_module import PreTrainedModel, AllGather, CrossEn, CrossEn_KL
...
class DLAR(CLIP4ClipPreTrainedModel):
    ...
    def forward(self, epoch, input_ids, token_type_ids, attention_mask, video, prototype, video_mask=None, lambda2=0.0):
        ...
        if self.training:
            ...
            return visual_output, sentence_output
        
    def mini_batch_output(self, sequence_output, seq_features, visual_output, attention_mask, video_mask, sim_header="meanP"):
        """
        ...
        return sentence_output, video_output
